...
export default function Page() {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-8 right-8 w-32 h-32 animate-bounce">
        <Image
      ...
      <div className="absolute top-1/4 left-8 w-16 h-16 animate-pulse">
        <Image
          src="/chibi-sticker.png"
          alt="Dhanush Chibi"
          fill
      ...
      <div className="absolute bottom-1/4 right-12 w-20 h-20 animate-spin" style={{ animationDuration: '20s' }}>
        <Image
          src="/chibi-sticker.png"
          alt="Dhanush Chibi"
          fill
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg">
            Continue your AI journey with Dhanush! ✨
          </p>
        </div>
        ...
        <div className="absolute -bottom-8 left-0 w-16 h-16 animate-bounce" style={{ animationDelay: '1s' }}>
          <Image
            src="/chibi-sticker.png"
            alt="Dhanush Chibi"
            fill
